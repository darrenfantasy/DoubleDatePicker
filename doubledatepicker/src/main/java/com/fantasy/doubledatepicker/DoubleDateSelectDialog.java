...
private String allowedBiggestTime;
    ...
    public DoubleDateSelectDialog(Context context, String curTime, String startTime) {
        super(context, R.style.PopBottomDialogStyle);
    ...
    public DoubleDateSelectDialog(Context context, String earliestTime, String startTime, String endTime) {
        super(context, R.style.PopBottomDialogStyle);
        this.mContext = context;
